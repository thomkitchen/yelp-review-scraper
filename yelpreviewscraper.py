...
#--------This routine grabs the product name to return in a list along with the reviews
...
if __name__ == '__main__':
    ...
    name, review = get_reviews("http://www.yelp.com/biz/brick-pizzeria-napoletana-new-bedford-2")
    print(name + '\n\n' + review)
